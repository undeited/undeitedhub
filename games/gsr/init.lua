local BASE_URL = "https://raw.githubusercontent.com/ObsidianFW/bandithub/main/"
...
LoadScript("games/gsr/esp.lua")
LoadScript("games/gsr/combat.lua")
LoadScript("games/gsr/autofarm.lua")
